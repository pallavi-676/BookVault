        ...
        <div className="p-4 md:p-8 max-w-7xl mx-auto pb-32">
          ...
          {discoverLoading ? (
            ...
            <div className="space-y-12 md:space-y-20">
               {/* Featured Hero Piece */}
               <section className="relative h-[400px] md:h-[450px] rounded-[32px] md:rounded-[48px] overflow-hidden group shadow-premium">
                  ...
                  <img 
                    ...
                    alt="Hero"
                  />
                  <div className="absolute inset-0 z-20 p-6 md:p-12 flex flex-col justify-end md:justify-center max-w-xl">
                     <span className="flex items-center gap-2 text-white/60 text-[10px] md:text-xs font-black uppercase tracking-[0.3em] mb-3 md:mb-4">
                        <Zap size={14} className="text-amber-400" /> Story of the Day
                     </span>
                     <h2 className="text-2xl md:text-5xl font-serif font-bold text-white mb-4 md:mb-6 leading-tight">Beyond the Sapphire Range</h2>
                     <p className="text-white/80 mb-6 md:mb-8 leading-relaxed line-clamp-3 md:line-clamp-2 text-xs md:text-base">A breathtaking epic about the last mountain keepers struggling to maintain the balance of a magic-infused world as empires rise from the valleys.</p>
                     <div className="flex gap-4">
                        <button className="px-5 md:px-8 py-2.5 md:py-3 bg-white text-bookvault-primary rounded-2xl font-bold shadow-xl hover:scale-105 transition-transform flex items-center gap-2 text-xs md:text-sm">
               ...
               <section>
                  <div className="flex items-center justify-between mb-6 md:mb-8">
                    <h2 className="text-xl md:text-2xl font-serif font-bold text-bookvault-primary flex items-center gap-2">
                       <Users size={22} className="text-bookvault-secondary" /> Trending Authors
                    </h2>
                    <button className="text-xs md:text-sm font-bold text-bookvault-primary/60 hover:text-bookvault-primary transition-colors">See all</button>
                  </div>
               ...
               <section>
                  <div className="flex items-center justify-between mb-6 md:mb-8">
                    <h2 className="text-xl md:text-2xl font-serif font-bold text-bookvault-primary flex items-center gap-2">
                       <Sparkles size={22} className="text-amber-400" /> New Releases
                    </h2>
                    <button className="text-xs md:text-sm font-bold text-bookvault-primary/60 hover:text-bookvault-primary transition-colors">See all</button>
                  </div>
               ...
               {/* Browse by Genre */}
               <section className="bg-bookvault-primary/5 rounded-[32px] md:rounded-[48px] p-6 md:p-12">
                  <h2 className="text-xl md:text-2xl font-serif font-bold text-bookvault-primary mb-6 md:mb-8 flex items-center gap-2">
                     <LayoutGrid size={22} className="text-bookvault-primary" /> Popular Genres
                  </h2>
                  <div className="flex flex-wrap gap-2 md:gap-4">
                     {['Fantasy', 'Romance', 'Thriller', 'Sci-Fi', 'Non-Fiction', 'Poetry', 'Drama', 'Horror', 'Mystery'].map((genre) => (
                        <button key={genre} className="px-4 md:px-8 py-2 md:py-4 bg-white dark:bg-zinc-800 rounded-xl md:rounded-2xl font-serif font-bold text-bookvault-primary hover:bg-bookvault-primary hover:text-white transition-all shadow-sm border border-bookvault-primary/10 text-xs md:text-base">
                           {genre}
                        </button>
                     ))}
                  </div>
